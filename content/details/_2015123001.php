...
<div class="media">
    ...
    investment strategies. We're wanting to optimize these strategies with
    respect to two metrics: growth and risk. An optimal investment strategy maximizes growth
    while minimizing risk. The goals of maximizing growth and minimizing risk often compete.
    ...
    I won't be concerned with the often conflicting relationship between
    ...
    work, we have developed a technique for predicting growth with "a reasonably
    high degree of accuracy." I'll discuss later in statistical terms
    what that means exactly. While the details of our algorithm are proprietary,
    I can also share a few of our results, their significance and their limitations.</p>
    ...
    The upper portion of the chart simply plots unprocessed values
    pulled from <a href="http://finance.yahoo.com" target="_blank">Yahoo! Finance</a>.
    Yahoo! provides historical <em>adjusted closes</em> for all equities 
    currently traded on the major exchanges. These prices are adjusted to account
    for both splits and dividends. Such adjustments necessary to get an accurate
    picture of actual return, whether or not the stock has split and whether or not
    ...
    available <em>in real time</em>. The prediction made on August 30, 2010,
    ...
    a month from now. Relative to the average or to other equities, we can
    say that predicted growht is better or worse, but tomorrow it
    might be better still. We won't know that until we apply the model
    to tomorrow's data. For example, toward the
    ...
    it would in fact have been a pretty good one, at least if you were willing to
    hold through the crash. If you waited
    ...
    provides useful information, a lot of work remains to be done to determine how best to make
