...
<div class="media">
    ...
    provide such a clear indicator of when to <em>sell</em>. <em>In hindsight</em>, we see
    that it would have been optimal to sell sometime around October 1 2007, whereas <em>in real time</em>
    the algorithm is still predicting a positive, albeit below average, return.
