...
<div class="media">
    ...
    <p>We're zooming in here on the two years before and after the stock price bottomed
    ...
    that we might want to <em>buy</em> a stock when we see
    high <span style="color:red">predicted growth</span>. The chart does not, however,
    provide such a clear indicator of when to <em>sell</em>. Even in hindsight, we see
    only from the top chart
    that it would have been optimal to sell sometime around October 1 2007.
    The lower chart generated by our model is of little help in determining
    this optimal sell point. 
    ...
    If this chart is representative, our prediction algorithm will likely help more in
    deciding when to buy than when to sell.</p>

    <p>In light of the strengths and limitations suggested by the GE chart, there
    are several ways that algorithmic investment strategies might make use of such
    predictions.</p>
